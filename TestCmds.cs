    ...
    public class CmdSnoopActiveView : IExternalCommand
    {
        public Result Execute(ExternalCommandData cmdData, ref string msg, ElementSet elems)
        {
            ...
            try
            {
                ...
                Objects form = new Objects(doc.ActiveView);
                form.ShowDialog();
    ...
    public class CmdSnoopModScope : IExternalCommand
    {
        public Result Execute(ExternalCommandData cmdData, ref string msg, ElementSet elems)
        {
            ...
            try
            {
                ...
                Objects form = new Objects(dbdoc, ids);
                ActiveDoc.UIApp = cmdData.Application;
                form.ShowDialog();
    ...
    public class CmdSnoopApp : IExternalCommand
    {
        public Result Execute(ExternalCommandData cmdData, ref string msg, ElementSet elems)
        {
            ...
            try
            {
                ...
                Objects form = new Objects(cmdData.Application.Application);
                form.ShowDialog();
                ActiveDoc.UIApp = cmdData.Application;
                result = Result.Succeeded;
            }
